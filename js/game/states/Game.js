Welpworld.Game = function() {
  ...
  this.velocidadeXJogador = 300;
  this.velocidadeYJogador = -400;
  this.gravidadeJogador = 600;
...
Welpworld.Game.prototype = {
 ...
 movimentoJogador2: function() {
  ...
  criarBalaJogador1: function(){
    ...
    jogo.definirVelocidadeY(bala, this.velocidadeYJogador);
    jogo.definirGravidadeY(bala, this.gravidadeJogador);
  },
